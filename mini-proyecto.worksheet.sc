...
/*
compuesta(funcion_1, 3, 5, 10)
compuesta(funcion_2, 0, 2, 10)
compuesta(funcion_3, -1, 1, 10)
compuesta(funcion_4, 1, 2, 10)
compuesta(funcion_5, 0, 1, 10)
compuesta(funcion_6, 2, 3, 10)
compuesta(funcion_7, 0, 1, 10)

*/

extendida(funcion_1, 3, 5)
extendida(funcion_2, 0, 2)
extendida(funcion_3, -1, 1)
extendida(funcion_4, 1, 2)
extendida(funcion_5, 0, 1)
extendida(funcion_6, 2, 3)
extendida(funcion_7, 0, 1)
